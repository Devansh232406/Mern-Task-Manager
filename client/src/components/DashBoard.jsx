...
const [tasks, settasks] = useState([]);
  ...
  const handleAddtask = async (e) => {
    ...
    try {
      const res = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/tasks`, {
        title: newtask.trim(),
  ...
  const handleUpdatetask = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`${process.env.REACT_APP_API_BASE_URL}/api/tasks/${editingId}`, {
        title: editText.trim(),
  ...
  const handleStatusChange = async (id, newStatus) => {
    try {
      ...
      const res = await axios.put(`${process.env.REACT_APP_API_BASE_URL}/api/tasks/${id}`, {
